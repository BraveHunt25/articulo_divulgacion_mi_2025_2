...
El presente trabajo abordó una problemática creciente de la escasez hídrica y la necesidad de optimizar su consumo en entornos urbanos, particularmente en el riego de jardines domésticos, un área donde las soluciones a menudo presentan limitaciones de costo y complejidad. El objetivo principal fue diseñar e implementar un asistente inteligente de riego en tiempo real basado en machine learning y los resultados demuestran la viabilidad y alta eficiencia del sistema propuesto.
