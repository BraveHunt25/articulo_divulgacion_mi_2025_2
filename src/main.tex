...
\makeatletter
\def\@title{\parbox[t]{\textwidth}{\justifying\LARGE\bfseries Diseño e implementación de asistente inteligente de riego en tiempo real usando \textit{machine learning} en un sistema embebido para reducir costos por consumo de agua en el cuidado del jardín doméstico en el domicilio lote 30 manzana 5, Calle Cerro De La Silla, colonia Sagitario 1, Ecatepec de Morelos en el periodo febrero-junio 2025}}
\makeatother
...
\textbf{\includegraphics[width=0.35cm]{example-image}\hspace{0.4em} Articulo }
\end{minipage}
\hfill
...
\noindent
El manejo ineficiente del recurso hídrico, especialmente en el cuidado de jardines domésticos, representa un desafío creciente en la optimización del consumo de agua y la reducción de costos asociados. Los métodos de riego tradicionales a menudo carecen de la adaptabilidad necesaria para responder a las condiciones ambientales en tiempo real, limitando la eficiencia y el ahorro. Ante esta problemática, presentamos el diseño e implementación de un asistente inteligente de riego en tiempo real, que integra un sistema embebido con algoritmos de machine learning. Este sistema, desarrollado para un domicilio específico en Ecatepec de Morelos durante el periodo de febrero a junio de 2025, busca optimizar el consumo de agua en jardines domésticos. Mediante la aplicación de aprendizaje automático, nuestro asistente es capaz de tomar decisiones de riego adaptativas, lo que contribuye directamente a la reducción de los costos hídricos. Los resultados resaltan el potencial de los sistemas inteligentes embebidos para abordar la complejidad del riego eficiente, proporcionando un marco adaptable para la gestión sostenible del agua en entornos residenciales.
\end{minipage}
...
A lo largo de los 10 días monitoreados, las temperaturas diarias se mantuvieron en un rango de 0°C a 35°C, con un promedio general de 23.38°C y una desviación estándar de 5.87°C para las temperaturas registradas. Además, se observó un descenso de temperatura del cuarto al quinto día, pasando de 25.2°C a 21.9°C. Posteriormente, la temperatura mostró una tendencia al alza.

\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\textwidth]{assets/temperatura_promedio.png}
  \caption{Temperatura promedio diaria.}
  \label{fig2}
\end{figure}

Con estos datos, se encontró una correlación positiva moderada entre las temperaturas registradas y la frecuencia de los eventos de riego (coeficiente de Pearson de 0.4602), indicando que a mayores temperaturas, la frecuencia de riego tiende a aumentar.

Sin embargo, se identificaron dos casos atípicos en los datos de temperatura y riego: una lectura de temperatura de 0°C y un evento de riego único registrado a 26°C.

\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\textwidth]{assets/temperatura_vs_riego.png}
  \caption{Frecuencia de riego contra temperatura ambiente.}
  \label{fig3}
\end{figure}
...
\newblock \bibinfo{title}{{Objetivo 11: Lograr que las ciudades sean más inclusivas, seguras, resilientes y sostenibles}} (\bibinfo{year}{2023}).
\newblock \bibinfo{note}{[En línea]. Disponible: \url{https://www.un.org/sustainabledevelopment/es/water-and-sanitation/}. [Último acceso: 21 06 2025]}.

\bibitem{ref2}
\bibinfo{author}{Vega López, E.}
\newblock \bibinfo{title}{{Agua, crecimiento económico y bienestar social en México}}.
\newblock \emph{\bibinfo{journal}{Revista de Economía Mexicana Anuario UNAM}} \textbf{\bibinfo{volume}{I}}, \bibinfo{pages}{233, 294} (\bibinfo{year}{2023}).

\bibitem{ref3}
\bibinfo{author}{Glória, A.}, \bibinfo{author}{Cardoso, J.} \& \bibinfo{author}{Sebastiäo, P.}
\newblock \bibinfo{title}{{Sustainable Irrigation System for Farming Supported by Machine Learning and Real-Time Sensor Data}}.
\newblock \emph{\bibinfo{journal}{Sensors}} (\bibinfo{year}{2021}).

\bibitem{ref4}
{Comisión del Agua del Estado de México}.
\newblock \bibinfo{title}{{Tarifas de agua potable, drenaje y tratamiento de aguas residuales}} (\bibinfo{year}{2024}).
\newblock \bibinfo{note}{[En línea]. Disponible: \url{https://caem.edomex.gob.mx/tarifas_agua_potable_drenaje_y_tratamiento_aguas_residuales}. [Último acceso: 21 06 2025]}.
